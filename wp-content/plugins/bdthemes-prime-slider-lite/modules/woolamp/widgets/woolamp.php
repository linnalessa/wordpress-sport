	...
	private function register_query_section_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-prime-slider-woolamp .bdt-ps-content-wrapper .bdt-ps-title' => 'color: {{VALUE}}; -webkit-text-stroke-color: {{VALUE}};',
				],
				'condition' => [
					'show_title' => ['yes'],
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-prime-slider-woolamp .bdt-ps-content-wrapper .bdt-ps-add-to-cart .button:hover:before' => 'background-color: {{VALUE}};',
				],
			]
		);
	...
	public function render_item_content() {
		...
		<div class="bdt-ps-content-inner">
			...
			<?php if ( $settings['show_title'] ) : ?>
				<<?php echo Utils::get_valid_html_tag($settings['title_html_tag']); ?> class="bdt-ps-title" bdt-slideshow-parallax="y: 70,0,-100; opacity: 1,1,0"><?php the_title(); ?></<?php echo Utils::get_valid_html_tag($settings['title_html_tag']); ?>>
			<?php endif; ?>
